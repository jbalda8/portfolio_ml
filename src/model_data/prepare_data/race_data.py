...
def prepare_race_data(data: Session) -> pd.DataFrame:
    ...
    This function obtains both the event descriptions, i.e. Country where the race took place, Grand Prix, etc., and potential response variables "Points" or "Position"

    Args:
        data: data: passed in as a fastf1 Session type. This datatype includes all possible information on the given session. This function uses it's "results" method to obtain result data and "event" method to obtain event information
